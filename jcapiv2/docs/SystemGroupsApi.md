...
try:
    ...
    print("Exception when calling SystemGroupsApi->graph_system_group_traverse_policy_group: %s\n" % e)
```
...
> SystemGroup groups_system_delete(id, x_org_id=x_org_id)
...
try:
    # Delete a System Group
    api_response = api_instance.groups_system_delete(id, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
...
# **groups_system_get**
> SystemGroup groups_system_get(id, x_org_id=x_org_id)
...
try:
    # View an individual System Group details
    api_response = api_instance.groups_system_get(id, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
...
# **groups_system_list**
> list[SystemGroup] groups_system_list(fields=fields, filter=filter, limit=limit, skip=skip, sort=sort, x_org_id=x_org_id)
...
try:
    # List all System Groups
    api_response = api_instance.groups_system_list(fields=fields, filter=filter, limit=limit, skip=skip, sort=sort, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
...
# **groups_system_post**
> SystemGroup groups_system_post(body=body, x_org_id=x_org_id)
...
try:
    # Create a new System Group
    api_response = api_instance.groups_system_post(body=body, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
...
# **groups_system_put**
> SystemGroup groups_system_put(id, body=body, x_org_id=x_org_id)
...
try:
    # Update a System Group
    api_response = api_instance.groups_system_put(id, body=body, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
