...
> groups_system_delete(id, content_type, accept, x_org_id=x_org_id)
...
try: 
    # Delete a System Group
    api_instance.groups_system_delete(id, content_type, accept, x_org_id=x_org_id)
except ApiException as e:
...
# **groups_system_get**
> SystemGroup groups_system_get(id, content_type, accept, x_org_id=x_org_id)
...
try: 
    # View an individual System Group details
    api_response = api_instance.groups_system_get(id, content_type, accept, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
...
# **groups_system_list**
> list[SystemGroup] groups_system_list(content_type, accept, fields=fields, filter=filter, limit=limit, skip=skip, sort=sort, x_org_id=x_org_id)
...
try: 
    # List all System Groups
    api_response = api_instance.groups_system_list(content_type, accept, fields=fields, filter=filter, limit=limit, skip=skip, sort=sort, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
...
# **groups_system_patch**
> SystemGroup groups_system_patch(id, content_type, accept, body=body, x_org_id=x_org_id)
...
try: 
    # Partial update a System Group
    api_response = api_instance.groups_system_patch(id, content_type, accept, body=body, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
...
# **groups_system_post**
> SystemGroup groups_system_post(content_type, accept, body=body, x_org_id=x_org_id)
...
try: 
    # Create a new System Group
    api_response = api_instance.groups_system_post(content_type, accept, body=body, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
...
# **groups_system_put**
> SystemGroup groups_system_put(id, content_type, accept, body=body, x_org_id=x_org_id)
...
try: 
    # Update a System Group
    api_response = api_instance.groups_system_put(id, content_type, accept, body=body, x_org_id=x_org_id)
    pprint(api_response)
except ApiException as e:
