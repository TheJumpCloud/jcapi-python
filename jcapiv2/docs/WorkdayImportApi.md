...
> list[JobWorkresult] workdays_importresults(id, job_id, content_type, accept, limit=limit, skip=skip)
...
try: 
    # List Import Results
    api_response = api_instance.workdays_importresults(id, job_id, content_type, accept, limit=limit, skip=skip)
    pprint(api_response)
except ApiException as e:
...
# **workdays_list**
> list[WorkdayOutput] workdays_list(content_type, accept, fields=fields, limit=limit, skip=skip, sort=sort, filter=filter)
...
try: 
    # List Workdays
    api_response = api_instance.workdays_list(content_type, accept, fields=fields, limit=limit, skip=skip, sort=sort, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **workdays_post**
> workdays_post(content_type, accept, body=body)
...
try: 
    # Create new Workday
    api_instance.workdays_post(content_type, accept, body=body)
except ApiException as e:
...
# **workdays_workers**
> list[WorkdayWorker] workdays_workers(workday_id, content_type, accept, limit=limit, skip=skip, sort=sort)
...
try: 
    # List Workday Workers
    api_response = api_instance.workdays_workers(workday_id, content_type, accept, limit=limit, skip=skip, sort=sort)
    pprint(api_response)
except ApiException as e:
