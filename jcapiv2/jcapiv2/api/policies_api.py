...
class PoliciesApi(object):
    ...
    def policystatuses_list_0(self, policy_id, content_type, accept, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.policystatuses_list_0(policy_id, content_type, accept, async=True)
        >>> result = thread.get()
    ...
    def policystatuses_list_0_with_http_info(self, policy_id, content_type, accept, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.policystatuses_list_0_with_http_info(policy_id, content_type, accept, async=True)
        >>> result = thread.get()
