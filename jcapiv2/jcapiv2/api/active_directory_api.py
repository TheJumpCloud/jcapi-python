...
class ActiveDirectoryApi(object):
    ...
    def activedirectories_agents_delete(self, activedirectory_id, agent_id, **kwargs):  # noqa: E501
        """Delete Active Directory Agent  # noqa: E501

        This endpoint deletes an Active Directory agent.  #### Sample Request ``` curl -X DELETE https://console.jumpcloud.com/api/v2/activedirectories/{activedirectory_id}/agents/{agent_id} \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_agents_delete(activedirectory_id, agent_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.activedirectories_agents_delete_with_http_info(activedirectory_id, agent_id, **kwargs)  # noqa: E501
        else:
            (data) = self.activedirectories_agents_delete_with_http_info(activedirectory_id, agent_id, **kwargs)  # noqa: E501
            return data

    def activedirectories_agents_delete_with_http_info(self, activedirectory_id, agent_id, **kwargs):  # noqa: E501
        """Delete Active Directory Agent  # noqa: E501

        This endpoint deletes an Active Directory agent.  #### Sample Request ``` curl -X DELETE https://console.jumpcloud.com/api/v2/activedirectories/{activedirectory_id}/agents/{agent_id} \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_agents_delete_with_http_info(activedirectory_id, agent_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['activedirectory_id', 'agent_id', 'x_org_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method activedirectories_agents_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('activedirectory_id' not in params or
            ...
            raise ValueError("Missing the required parameter `activedirectory_id` when calling `activedirectories_agents_delete`")  # noqa: E501
        # verify the required parameter 'agent_id' is set
        if ('agent_id' not in params or
                params['agent_id'] is None):
            raise ValueError("Missing the required parameter `agent_id` when calling `activedirectories_agents_delete`")  # noqa: E501
    ...
    def activedirectories_agents_get(self, activedirectory_id, agent_id, **kwargs):  # noqa: E501
        """Get Active Directory Agent  # noqa: E501

        This endpoint returns an Active Directory agent.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/activedirectories/{activedirectory_id}/agents/{agent_id} \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_agents_get(activedirectory_id, agent_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activedirectories_agents_get_with_http_info(activedirectory_id, agent_id, **kwargs)  # noqa: E501
        else:
            (data) = self.activedirectories_agents_get_with_http_info(activedirectory_id, agent_id, **kwargs)  # noqa: E501
            return data

    def activedirectories_agents_get_with_http_info(self, activedirectory_id, agent_id, **kwargs):  # noqa: E501
        """Get Active Directory Agent  # noqa: E501

        This endpoint returns an Active Directory agent.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/activedirectories/{activedirectory_id}/agents/{agent_id} \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_agents_get_with_http_info(activedirectory_id, agent_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method activedirectories_agents_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'activedirectory_id' is set
        if ('activedirectory_id' not in params or
                params['activedirectory_id'] is None):
            raise ValueError("Missing the required parameter `activedirectory_id` when calling `activedirectories_agents_get`")  # noqa: E501
        # verify the required parameter 'agent_id' is set
        if ('agent_id' not in params or
                params['agent_id'] is None):
            raise ValueError("Missing the required parameter `agent_id` when calling `activedirectories_agents_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ActiveDirectoryAgentListOutput',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def activedirectories_agents_list(self, activedirectory_id, **kwargs):  # noqa: E501
        """List Active Directory Agents  # noqa: E501

        This endpoint allows you to list all your Active Directory Agents for a given Instance.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/activedirectories/{activedirectory_id}/agents \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}'   ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_agents_list(activedirectory_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activedirectories_agents_list_with_http_info(activedirectory_id, **kwargs)  # noqa: E501
        else:
            (data) = self.activedirectories_agents_list_with_http_info(activedirectory_id, **kwargs)  # noqa: E501
            return data

    def activedirectories_agents_list_with_http_info(self, activedirectory_id, **kwargs):  # noqa: E501
        """List Active Directory Agents  # noqa: E501

        This endpoint allows you to list all your Active Directory Agents for a given Instance.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/activedirectories/{activedirectory_id}/agents \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}'   ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_agents_list_with_http_info(activedirectory_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['activedirectory_id', 'limit', 'skip', 'sort', 'x_org_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method activedirectories_agents_list" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'activedirectory_id' is set
        if ('activedirectory_id' not in params or
                params['activedirectory_id'] is None):
            raise ValueError("Missing the required parameter `activedirectory_id` when calling `activedirectories_agents_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ActiveDirectoryAgentListOutput]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def activedirectories_agents_post(self, activedirectory_id, **kwargs):  # noqa: E501
        """Create a new Active Directory Agent  # noqa: E501

        This endpoint allows you to create a new Active Directory Agent.   #### Sample Request ``` curl -X POST https://console.jumpcloud.com/api/v2/activedirectories/{activedirectory_id}/agents \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_agents_post(activedirectory_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str activedirectory_id: (required)
        :param ActiveDirectoryAgentInput body:
        :param str x_org_id: Organization identifier that can be obtained from console settings.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activedirectories_agents_post_with_http_info(activedirectory_id, **kwargs)  # noqa: E501
        else:
            (data) = self.activedirectories_agents_post_with_http_info(activedirectory_id, **kwargs)  # noqa: E501
            return data

    def activedirectories_agents_post_with_http_info(self, activedirectory_id, **kwargs):  # noqa: E501
        """Create a new Active Directory Agent  # noqa: E501

        This endpoint allows you to create a new Active Directory Agent.   #### Sample Request ``` curl -X POST https://console.jumpcloud.com/api/v2/activedirectories/{activedirectory_id}/agents \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_agents_post_with_http_info(activedirectory_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method activedirectories_agents_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'activedirectory_id' is set
        if ('activedirectory_id' not in params or
                params['activedirectory_id'] is None):
            raise ValueError("Missing the required parameter `activedirectory_id` when calling `activedirectories_agents_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ActiveDirectoryAgentGetOutput',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def activedirectories_delete(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activedirectories_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.activedirectories_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def activedirectories_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete an Active Directory  # noqa: E501

        This endpoint allows you to delete an Active Directory Instance.  #### Sample Request ``` curl -X DELETE https://console.jumpcloud.com/api/v2/activedirectories/{ActiveDirectory_ID} \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}'   ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def activedirectories_get(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activedirectories_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.activedirectories_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def activedirectories_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get an Active Directory  # noqa: E501

        This endpoint returns a specific Active Directory.  #### Sample Request  ``` curl -X GET https://console.jumpcloud.com/api/v2/activedirectories/{ActiveDirectory_ID} \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}'   ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def activedirectories_list(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activedirectories_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.activedirectories_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def activedirectories_list_with_http_info(self, **kwargs):  # noqa: E501
        """List Active Directories  # noqa: E501

        This endpoint allows you to list all your Active Directory Instances.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/activedirectories/ \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}'   ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_list_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def activedirectories_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activedirectories_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.activedirectories_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def activedirectories_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create a new Active Directory  # noqa: E501

        This endpoint allows you to create a new Active Directory.   #### Sample Request ``` curl -X POST https://console.jumpcloud.com/api/v2/activedirectories/ \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{     \"domain\": \"{DC=AD_domain_name;DC=com}\"   }' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activedirectories_post_with_http_info(async_req=True)
        >>> result = thread.get()
