...
class PolicyGroupsApi(object):
    ...
    def groups_policy_delete(self, id, **kwargs):  # noqa: E501
        """Delete a Policy Group  # noqa: E501

        This endpoint allows you to delete a Policy Group.  #### Sample Request ``` curl -X DELETE https://console.jumpcloud.com/api/v2/policygroups/{GroupID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}'  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_delete(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: ObjectID of the Policy Group. (required)
        :param str x_org_id: Organization identifier that can be obtained from console settings.
        :return: PolicyGroup
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.groups_policy_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.groups_policy_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def groups_policy_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete a Policy Group  # noqa: E501

        This endpoint allows you to delete a Policy Group.  #### Sample Request ``` curl -X DELETE https://console.jumpcloud.com/api/v2/policygroups/{GroupID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}'  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method groups_policy_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `groups_policy_delete`")  # noqa: E501
    ...
    def groups_policy_get(self, id, **kwargs):  # noqa: E501
        """View an individual Policy Group details  # noqa: E501

        This endpoint returns the details of a Policy Group.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/policygroups/{GroupID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.groups_policy_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.groups_policy_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def groups_policy_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """View an individual Policy Group details  # noqa: E501

        This endpoint returns the details of a Policy Group.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/policygroups/{GroupID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method groups_policy_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `groups_policy_get`")  # noqa: E501
    ...
    def groups_policy_list(self, **kwargs):  # noqa: E501
        """List all Policy Groups  # noqa: E501

        This endpoint returns all Policy Groups.  Available filter fields:   - `name`   - `disabled`   - `type`  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/policygroups \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.groups_policy_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.groups_policy_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def groups_policy_list_with_http_info(self, **kwargs):  # noqa: E501
        """List all Policy Groups  # noqa: E501

        This endpoint returns all Policy Groups.  Available filter fields:   - `name`   - `disabled`   - `type`  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/policygroups \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method groups_policy_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[PolicyGroup]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def groups_policy_post(self, **kwargs):  # noqa: E501
        """Create a new Policy Group  # noqa: E501

        This endpoint allows you to create a new Policy Group.  #### Sample Request ``` curl -X POST https://console.jumpcloud.com/api/v2/policygroups \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{     \"name\": \"{Group_Name}\"   }' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PolicyGroupData body:
        :param str x_org_id: Organization identifier that can be obtained from console settings.
        :return: PolicyGroup
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.groups_policy_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.groups_policy_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def groups_policy_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create a new Policy Group  # noqa: E501

        This endpoint allows you to create a new Policy Group.  #### Sample Request ``` curl -X POST https://console.jumpcloud.com/api/v2/policygroups \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{     \"name\": \"{Group_Name}\"   }' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method groups_policy_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def groups_policy_put(self, id, **kwargs):  # noqa: E501
        """Update a Policy Group  # noqa: E501

        This endpoint allows you to do a full update of the Policy Group.  #### Sample Request ``` curl -X PUT https://console.jumpcloud.com/api/v2/policygroups/{Group_ID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{     \"name\": \"group_update\"   }' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_put(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.groups_policy_put_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.groups_policy_put_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def groups_policy_put_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update a Policy Group  # noqa: E501

        This endpoint allows you to do a full update of the Policy Group.  #### Sample Request ``` curl -X PUT https://console.jumpcloud.com/api/v2/policygroups/{Group_ID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{     \"name\": \"group_update\"   }' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.groups_policy_put_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method groups_policy_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `groups_policy_put`")  # noqa: E501
