...
class SystemsApi(object):
    ...
    def systems_list_software_apps_with_statuses(self, system_id, **kwargs):  # noqa: E501
        """List the associated Software Application Statuses of a System  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.systems_list_software_apps_with_statuses(system_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.systems_list_software_apps_with_statuses_with_http_info(system_id, **kwargs)  # noqa: E501
        else:
            (data) = self.systems_list_software_apps_with_statuses_with_http_info(system_id, **kwargs)  # noqa: E501
            return data

    def systems_list_software_apps_with_statuses_with_http_info(self, system_id, **kwargs):  # noqa: E501
        """List the associated Software Application Statuses of a System  # noqa: E501

        This endpoint returns all the statuses of the associated Software Applications from the provided JumpCloud system ID.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/systems/{system_id}/softwareappstatuses \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}'  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.systems_list_software_apps_with_statuses_with_http_info(system_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['system_id', 'x_org_id', 'filter', 'limit', 'skip', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method systems_list_software_apps_with_statuses" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'system_id' is set
        if ('system_id' not in params or
                params['system_id'] is None):
            raise ValueError("Missing the required parameter `system_id` when calling `systems_list_software_apps_with_statuses`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[SoftwareAppWithStatus]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
