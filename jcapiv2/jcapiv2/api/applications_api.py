...
class ApplicationsApi(object):
    ...
    def applications_delete_logo(self, application_id, **kwargs):  # noqa: E501
        """Delete application image  # noqa: E501

        Deletes the specified image from an application  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_delete_logo(application_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.applications_delete_logo_with_http_info(application_id, **kwargs)  # noqa: E501
        else:
            (data) = self.applications_delete_logo_with_http_info(application_id, **kwargs)  # noqa: E501
            return data

    def applications_delete_logo_with_http_info(self, application_id, **kwargs):  # noqa: E501
        """Delete application image  # noqa: E501

        Deletes the specified image from an application  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_delete_logo_with_http_info(application_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['application_id', 'x_org_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method applications_delete_logo" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('application_id' not in params or
            ...
            raise ValueError("Missing the required parameter `application_id` when calling `applications_delete_logo`")  # noqa: E501
    ...
    def applications_get(self, application_id, **kwargs):  # noqa: E501
        """Get an Application  # noqa: E501

        The endpoint retrieves an Application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_get(application_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.applications_get_with_http_info(application_id, **kwargs)  # noqa: E501
        else:
            (data) = self.applications_get_with_http_info(application_id, **kwargs)  # noqa: E501
            return data

    def applications_get_with_http_info(self, application_id, **kwargs):  # noqa: E501
        """Get an Application  # noqa: E501

        The endpoint retrieves an Application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_get_with_http_info(application_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('application_id' not in params or
                params['application_id'] is None):
            raise ValueError("Missing the required parameter `application_id` when calling `applications_get`")  # noqa: E501
    ...
    def applications_post_logo(self, application_id, **kwargs):  # noqa: E501
        """applications_post_logo  # noqa: E501

        This endpoint sets the logo for an application.  #### Sample Request ``` curl -X POST 'https://console.jumpcloud.com/api/v2/applications/{Application_ID}/logo \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_post_logo(application_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.applications_post_logo_with_http_info(application_id, **kwargs)  # noqa: E501
        else:
            (data) = self.applications_post_logo_with_http_info(application_id, **kwargs)  # noqa: E501
            return data

    def applications_post_logo_with_http_info(self, application_id, **kwargs):  # noqa: E501
        """applications_post_logo  # noqa: E501

        This endpoint sets the logo for an application.  #### Sample Request ``` curl -X POST 'https://console.jumpcloud.com/api/v2/applications/{Application_ID}/logo \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_post_logo_with_http_info(application_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['application_id', 'image', 'x_org_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method applications_post_logo" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'application_id' is set
        if ('application_id' not in params or
                params['application_id'] is None):
            raise ValueError("Missing the required parameter `application_id` when calling `applications_post_logo`")  # noqa: E501
    ...
    def import_users(self, application_id, **kwargs):  # noqa: E501
        """Get a list of users to import from an Application IdM service provider  # noqa: E501

        Get a list of users to import from an Application IdM service provider.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_users(application_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str application_id: ObjectID of the Application. (required)
        :param str filter: Filter users by a search term
        :param str query: URL query to merge with the service provider request
        :param str sort: Sort users by supported fields
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.import_users_with_http_info(application_id, **kwargs)  # noqa: E501
        else:
            (data) = self.import_users_with_http_info(application_id, **kwargs)  # noqa: E501
            return data

    def import_users_with_http_info(self, application_id, **kwargs):  # noqa: E501
        """Get a list of users to import from an Application IdM service provider  # noqa: E501

        Get a list of users to import from an Application IdM service provider.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_users_with_http_info(application_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['application_id', 'filter', 'query', 'sort', 'sort_order', 'x_org_id', 'limit', 'skip']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('application_id' not in params or
                params['application_id'] is None):
            raise ValueError("Missing the required parameter `application_id` when calling `import_users`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ImportUsersResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
