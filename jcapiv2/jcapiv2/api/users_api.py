...
class UsersApi(object):
    ...
    def push_endpoints_delete(self, user_id, push_endpoint_id, **kwargs):  # noqa: E501
        """Delete a Push Endpoint associated with a User  # noqa: E501

        This endpoint will delete a push endpoint associated with a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.push_endpoints_delete(user_id, push_endpoint_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str user_id: (required)
        :param str push_endpoint_id: (required)
        :param str x_org_id: Organization identifier that can be obtained from console settings.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.push_endpoints_delete_with_http_info(user_id, push_endpoint_id, **kwargs)  # noqa: E501
        else:
            (data) = self.push_endpoints_delete_with_http_info(user_id, push_endpoint_id, **kwargs)  # noqa: E501
            return data

    def push_endpoints_delete_with_http_info(self, user_id, push_endpoint_id, **kwargs):  # noqa: E501
        """Delete a Push Endpoint associated with a User  # noqa: E501

        This endpoint will delete a push endpoint associated with a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.push_endpoints_delete_with_http_info(user_id, push_endpoint_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'push_endpoint_id', 'x_org_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method push_endpoints_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `push_endpoints_delete`")  # noqa: E501
        # verify the required parameter 'push_endpoint_id' is set
        if ('push_endpoint_id' not in params or
                params['push_endpoint_id'] is None):
            raise ValueError("Missing the required parameter `push_endpoint_id` when calling `push_endpoints_delete`")  # noqa: E501
        ...
        if 'user_id' in params:
            path_params['user_id'] = params['user_id']  # noqa: E501
        if 'push_endpoint_id' in params:
            path_params['push_endpoint_id'] = params['push_endpoint_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PushEndpointResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def push_endpoints_get(self, user_id, push_endpoint_id, **kwargs):  # noqa: E501
        """Get a push endpoint associated with a User  # noqa: E501

        This endpoint will retrieve a push endpoint associated with a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.push_endpoints_get(user_id, push_endpoint_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.push_endpoints_get_with_http_info(user_id, push_endpoint_id, **kwargs)  # noqa: E501
        else:
            (data) = self.push_endpoints_get_with_http_info(user_id, push_endpoint_id, **kwargs)  # noqa: E501
            return data

    def push_endpoints_get_with_http_info(self, user_id, push_endpoint_id, **kwargs):  # noqa: E501
        """Get a push endpoint associated with a User  # noqa: E501

        This endpoint will retrieve a push endpoint associated with a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.push_endpoints_get_with_http_info(user_id, push_endpoint_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method push_endpoints_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `push_endpoints_get`")  # noqa: E501
        # verify the required parameter 'push_endpoint_id' is set
        if ('push_endpoint_id' not in params or
                params['push_endpoint_id'] is None):
            raise ValueError("Missing the required parameter `push_endpoint_id` when calling `push_endpoints_get`")  # noqa: E501
    ...
    def push_endpoints_list(self, user_id, **kwargs):  # noqa: E501
        """List Push Endpoints associated with a User  # noqa: E501

        This endpoint returns the list of push endpoints associated with a user.  #### Sample Request  ``` curl -X GET https://console.jumpcloud.com/api/v2/users/{UserID}/pushendpoints \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: ${API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.push_endpoints_list(user_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.push_endpoints_list_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.push_endpoints_list_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def push_endpoints_list_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """List Push Endpoints associated with a User  # noqa: E501

        This endpoint returns the list of push endpoints associated with a user.  #### Sample Request  ``` curl -X GET https://console.jumpcloud.com/api/v2/users/{UserID}/pushendpoints \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: ${API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.push_endpoints_list_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'x_org_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method push_endpoints_list" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `push_endpoints_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[PushEndpointResponse]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def push_endpoints_patch(self, user_id, push_endpoint_id, **kwargs):  # noqa: E501
        """Update a push endpoint associated with a User  # noqa: E501

        This endpoint will update a push endpoint associated with a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.push_endpoints_patch(user_id, push_endpoint_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str user_id: (required)
        :param str push_endpoint_id: (required)
        :param PushendpointsPushEndpointIdBody body:
        :param str x_org_id: Organization identifier that can be obtained from console settings.
        :return: PushEndpointResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.push_endpoints_patch_with_http_info(user_id, push_endpoint_id, **kwargs)  # noqa: E501
        else:
            (data) = self.push_endpoints_patch_with_http_info(user_id, push_endpoint_id, **kwargs)  # noqa: E501
            return data

    def push_endpoints_patch_with_http_info(self, user_id, push_endpoint_id, **kwargs):  # noqa: E501
        """Update a push endpoint associated with a User  # noqa: E501

        This endpoint will update a push endpoint associated with a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.push_endpoints_patch_with_http_info(user_id, push_endpoint_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'push_endpoint_id', 'body', 'x_org_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method push_endpoints_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `push_endpoints_patch`")  # noqa: E501
        # verify the required parameter 'push_endpoint_id' is set
        if ('push_endpoint_id' not in params or
                params['push_endpoint_id'] is None):
            raise ValueError("Missing the required parameter `push_endpoint_id` when calling `push_endpoints_patch`")  # noqa: E501
