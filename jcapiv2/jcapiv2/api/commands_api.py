...
class CommandsApi(object):
    ...
    def commands_cancel_queued_commands_by_workflow_instance_id(self, workflow_instance_id, **kwargs):  # noqa: E501
        """Cancel all queued commands for an organization by workflow instance Id  # noqa: E501

        This endpoint allows all queued commands for one workflow instance to be canceled.  #### Sample Request ```  curl -X DELETE https://console.jumpcloud.com/api/v2/commandqueue/{workflow_instance_id} \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_cancel_queued_commands_by_workflow_instance_id(workflow_instance_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str workflow_instance_id: Workflow instance Id of the queued commands to cancel. (required)
        ...
        if kwargs.get('async_req'):
            return self.commands_cancel_queued_commands_by_workflow_instance_id_with_http_info(workflow_instance_id, **kwargs)  # noqa: E501
        else:
            (data) = self.commands_cancel_queued_commands_by_workflow_instance_id_with_http_info(workflow_instance_id, **kwargs)  # noqa: E501
            return data

    def commands_cancel_queued_commands_by_workflow_instance_id_with_http_info(self, workflow_instance_id, **kwargs):  # noqa: E501
        """Cancel all queued commands for an organization by workflow instance Id  # noqa: E501

        This endpoint allows all queued commands for one workflow instance to be canceled.  #### Sample Request ```  curl -X DELETE https://console.jumpcloud.com/api/v2/commandqueue/{workflow_instance_id} \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_cancel_queued_commands_by_workflow_instance_id_with_http_info(workflow_instance_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['workflow_instance_id', 'x_org_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method commands_cancel_queued_commands_by_workflow_instance_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('workflow_instance_id' not in params or
            ...
            raise ValueError("Missing the required parameter `workflow_instance_id` when calling `commands_cancel_queued_commands_by_workflow_instance_id`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'workflow_instance_id' in params:
            path_params['workflow_instance_id'] = params['workflow_instance_id']  # noqa: E501
    ...
    def commands_get_queued_commands_by_workflow(self, **kwargs):  # noqa: E501
        """Fetch the queued Commands for an Organization  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_get_queued_commands_by_workflow(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.commands_get_queued_commands_by_workflow_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.commands_get_queued_commands_by_workflow_with_http_info(**kwargs)  # noqa: E501
            return data

    def commands_get_queued_commands_by_workflow_with_http_info(self, **kwargs):  # noqa: E501
        """Fetch the queued Commands for an Organization  # noqa: E501

        This endpoint will return all queued Commands for an Organization.  Each element will contain the workflow ID, the command name, the launch type (e.g. manual, triggered, or scheduled), the target OS, the number of assigned devices, and the number of pending devices that have not yet ran the command.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/v2/queuedcommand/workflows \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_get_queued_commands_by_workflow_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['x_org_id', 'limit', 'filter', 'skip']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method commands_get_queued_commands_by_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='QueuedCommandList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
