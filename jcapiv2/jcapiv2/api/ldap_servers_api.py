...
class LDAPServersApi(object):
    ...
    def ldapservers_get(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ldapservers_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.ldapservers_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def ldapservers_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get LDAP Server  # noqa: E501

        This endpoint returns a specific LDAP server.  ##### Sample Request  ```  curl -X GET https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def ldapservers_list(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ldapservers_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.ldapservers_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def ldapservers_list_with_http_info(self, **kwargs):  # noqa: E501
        """List LDAP Servers  # noqa: E501

        This endpoint returns the object IDs of your LDAP servers.   ##### Sample Request  ```   curl -X GET https://console.jumpcloud.com/api/v2/ldapservers/ \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}'  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_list_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def ldapservers_patch(self, id, **kwargs):  # noqa: E501
        """Update existing LDAP server  # noqa: E501

        This endpoint allows updating some attributes of an LDAP server.  Sample Request  ``` curl -X PATCH https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{     \"userLockoutAction\": \"remove\",     \"userPasswordExpirationAction\": \"disable\"   }' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_patch(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Unique identifier of the LDAP server. (required)
        :param LdapserversIdBody body:
        :param str x_org_id: Organization identifier that can be obtained from console settings.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ldapservers_patch_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.ldapservers_patch_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def ldapservers_patch_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update existing LDAP server  # noqa: E501

        This endpoint allows updating some attributes of an LDAP server.  Sample Request  ``` curl -X PATCH https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{     \"userLockoutAction\": \"remove\",     \"userPasswordExpirationAction\": \"disable\"   }' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_patch_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method ldapservers_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `ldapservers_patch`")  # noqa: E501
