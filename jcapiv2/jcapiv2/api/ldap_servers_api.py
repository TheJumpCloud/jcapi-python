...
class LDAPServersApi(object):
    ...
    def ldapservers_get(self, id, content_type, accept, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_get(id, content_type, accept, async_req=True)
        >>> result = thread.get()
    ...
    def ldapservers_get_with_http_info(self, id, content_type, accept, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_get_with_http_info(id, content_type, accept, async_req=True)
        >>> result = thread.get()
    ...
    def ldapservers_list(self, content_type, accept, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_list(content_type, accept, async_req=True)
        >>> result = thread.get()
    ...
    def ldapservers_list_with_http_info(self, content_type, accept, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_list_with_http_info(content_type, accept, async_req=True)
        >>> result = thread.get()
        ...
        if 'skip' in params and params['skip'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `skip` when calling `ldapservers_list`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def ldapservers_patch(self, id, content_type, accept, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_patch(id, content_type, accept, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ldapservers_patch_with_http_info(id, content_type, accept, **kwargs)  # noqa: E501
        else:
            (data) = self.ldapservers_patch_with_http_info(id, content_type, accept, **kwargs)  # noqa: E501
            return data

    def ldapservers_patch_with_http_info(self, id, content_type, accept, **kwargs):  # noqa: E501
        """Update existing LDAP server  # noqa: E501

        This endpoint allows updating some attributes of an LDAP server.  Sample Request  ``` curl -X PATCH https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{     \"userLockoutAction\": \"remove\",     \"userPasswordExpirationAction\": \"disable\"   }' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ldapservers_patch_with_http_info(id, content_type, accept, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'content_type', 'accept', 'body', 'x_api_key', 'x_org_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('content_type' not in params or
                params['content_type'] is None):
            raise ValueError("Missing the required parameter `content_type` when calling `ldapservers_patch`")  # noqa: E501
        # verify the required parameter 'accept' is set
        if ('accept' not in params or
                params['accept'] is None):
            raise ValueError("Missing the required parameter `accept` when calling `ldapservers_patch`")  # noqa: E501
