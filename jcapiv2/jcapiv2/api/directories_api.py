...
class DirectoriesApi(object):
    ...
    def directories_list(self, **kwargs):  # noqa: E501
        """List All Directories  # noqa: E501

        This endpoint returns all active directories (LDAP, O365 Suite, G-Suite).  #### Sample Request ```  curl -X GET https://console.jumpcloud.com/api/v2/directories \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.directories_list(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.directories_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.directories_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def directories_list_with_http_info(self, **kwargs):  # noqa: E501
        """List All Directories  # noqa: E501

        This endpoint returns all active directories (LDAP, O365 Suite, G-Suite).  #### Sample Request ```  curl -X GET https://console.jumpcloud.com/api/v2/directories \\   -H 'accept: application/json' \\   -H 'content-type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.directories_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['fields', 'limit', 'sort', 'skip', 'x_org_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[Directory]',  # noqa: E501
