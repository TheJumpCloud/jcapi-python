...
class UserGraphManagementReq(object):
    ...
    def op(self):
        """
        Gets the op of this UserGraphManagementReq.
        How to modify the graph connection.

        :return: The op of this UserGraphManagementReq.
        :rtype: str
        """
        return self._op
    ...
    def op(self, op):
        ...
        :param op: The op of this UserGraphManagementReq.
        :type: str
        """
        if op is None:
    ...
    def type(self):
        """
        Gets the type of this UserGraphManagementReq.

        :return: The type of this UserGraphManagementReq.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this UserGraphManagementReq.
        :type: str
        """
        if type is None:
    ...
    def id(self):
        """
        Gets the id of this UserGraphManagementReq.
        The ObjectID of graph object being added or removed as an association.

        :return: The id of this UserGraphManagementReq.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this UserGraphManagementReq.
        :type: str
        """
        if id is None:
