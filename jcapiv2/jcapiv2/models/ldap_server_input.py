...
class LdapServerInput(object):
    ...
    @property
    def name(self):
        """Gets the name of this LdapServerInput.  # noqa: E501

        The name of this LDAP server  # noqa: E501

        :return: The name of this LdapServerInput.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LdapServerInput.

        The name of this LDAP server  # noqa: E501

        :param name: The name of this LdapServerInput.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LdapServerInput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LdapServerInput):
            return False
