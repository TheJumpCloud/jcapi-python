...
class Office365DirectionTranslation(object):
    ...
    def __init__(self):  # noqa: E501
        """Office365DirectionTranslation - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Office365DirectionTranslation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Office365DirectionTranslation):
            return False
