...
class Systemuser(object):
    ...
    def email(self, email):
        ...
        if email is not None and len(email) > 1024:
            raise ValueError("Invalid value for `email`, length must be less than or equal to `1024`")
    ...
    def username(self, username):
        ...
        if username is not None and len(username) > 1024:
            raise ValueError("Invalid value for `username`, length must be less than or equal to `1024`")
    ...
    def firstname(self, firstname):
        ...
        if firstname is not None and len(firstname) > 1024:
            raise ValueError("Invalid value for `firstname`, length must be less than or equal to `1024`")
    ...
    def lastname(self, lastname):
        ...
        if lastname is not None and len(lastname) > 1024:
            raise ValueError("Invalid value for `lastname`, length must be less than or equal to `1024`")
    ...
    def middlename(self, middlename):
        ...
        if middlename is not None and len(middlename) > 1024:
            raise ValueError("Invalid value for `middlename`, length must be less than or equal to `1024`")
    ...
    def displayname(self, displayname):
        ...
        if displayname is not None and len(displayname) > 1024:
            raise ValueError("Invalid value for `displayname`, length must be less than or equal to `1024`")
    ...
    def location(self, location):
        ...
        if location is not None and len(location) > 1024:
            raise ValueError("Invalid value for `location`, length must be less than or equal to `1024`")
    ...
    def cost_center(self, cost_center):
        ...
        if cost_center is not None and len(cost_center) > 1024:
            raise ValueError("Invalid value for `cost_center`, length must be less than or equal to `1024`")
    ...
    def employee_type(self, employee_type):
        ...
        if employee_type is not None and len(employee_type) > 1024:
            raise ValueError("Invalid value for `employee_type`, length must be less than or equal to `1024`")
    ...
    def company(self, company):
        ...
        if company is not None and len(company) > 1024:
            raise ValueError("Invalid value for `company`, length must be less than or equal to `1024`")
    ...
    def job_title(self, job_title):
        ...
        if job_title is not None and len(job_title) > 1024:
            raise ValueError("Invalid value for `job_title`, length must be less than or equal to `1024`")
    ...
    def department(self, department):
        ...
        if department is not None and len(department) > 1024:
            raise ValueError("Invalid value for `department`, length must be less than or equal to `1024`")
