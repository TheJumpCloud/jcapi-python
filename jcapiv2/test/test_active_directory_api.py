...
class TestActiveDirectoryApi(unittest.TestCase):
    ...
    def test_activedirectories_agents_delete(self):
        """Test case for activedirectories_agents_delete

        Delete Active Directory Agent  # noqa: E501
        """
        pass

    def test_activedirectories_agents_get(self):
        """Test case for activedirectories_agents_get
