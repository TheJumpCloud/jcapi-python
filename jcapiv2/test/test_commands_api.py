...
class TestCommandsApi(unittest.TestCase):
    ...
    def test_commands_cancel_queued_commands_by_workflow_instance_id(self):
        """Test case for commands_cancel_queued_commands_by_workflow_instance_id

        Cancel all queued commands for an organization by workflow instance Id  # noqa: E501
        """
        pass

    def test_commands_get_queued_commands_by_workflow(self):
        """Test case for commands_get_queued_commands_by_workflow
