...
class TestBulkJobRequestsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = BulkJobRequestsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_bulk_user_states_create(self):
        """Test case for bulk_user_states_create

        Create Scheduled Userstate Job  # noqa: E501
        """
        pass

    def test_bulk_user_states_delete(self):
        """Test case for bulk_user_states_delete

        Delete Scheduled Userstate Job  # noqa: E501
        """
        pass

    def test_bulk_user_states_get_next_scheduled(self):
        """Test case for bulk_user_states_get_next_scheduled

        Gets the next scheduled state change for each user in a list of system users  # noqa: E501
        """
        pass

    def test_bulk_user_states_list(self):
        """Test case for bulk_user_states_list
