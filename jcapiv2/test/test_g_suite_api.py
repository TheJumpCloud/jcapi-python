...
class TestGSuiteApi(unittest.TestCase):
    ...
    def test_gsuites_get(self):
        """Test case for gsuites_get

        Get G Suite  # noqa: E501
        """
        pass

    def test_gsuites_list_import_jumpcloud_users(self):
        """Test case for gsuites_list_import_jumpcloud_users

        Get a list of users in Jumpcloud format to import from a Google Workspace account.  # noqa: E501
        """
        pass

    def test_gsuites_list_import_users(self):
        """Test case for gsuites_list_import_users

        Get a list of users to import from a G Suite instance  # noqa: E501
        """
        pass

    def test_gsuites_patch(self):
        """Test case for gsuites_patch
