...
from jcapiv2.apis.workday_api import WorkdayApi


class TestWorkdayApi(unittest.TestCase):
    """ WorkdayApi unit test stubs """

    def setUp(self):
        self.api = jcapiv2.apis.workday_api.WorkdayApi()
    ...
    def test_workdays_report(self):
        """
        Test case for workdays_report
