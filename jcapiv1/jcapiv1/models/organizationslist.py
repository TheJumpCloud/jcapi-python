...
class Organizationslist(object):
    ...
    @property
    def results(self):
        """Gets the results of this Organizationslist.  # noqa: E501

        The list of organizations.  # noqa: E501

        :return: The results of this Organizationslist.  # noqa: E501
        :rtype: list[OrganizationslistResults]
        """
        return self._results

    @results.setter
    def results(self, results):
        """Sets the results of this Organizationslist.

        The list of organizations.  # noqa: E501

        :param results: The results of this Organizationslist.  # noqa: E501
        :type: list[OrganizationslistResults]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Organizationslist, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Organizationslist):
            return False
