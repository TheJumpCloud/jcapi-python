...
class SystemuserputpostAddresses(object):
    ...
    def __init__(self, type=None, po_box=None, extended_address=None, street_address=None, locality=None, region=None, postal_code=None, country=None):
        """
        SystemuserputpostAddresses - a model defined in Swagger
        """
    ...
    def type(self):
        """
        Gets the type of this SystemuserputpostAddresses.

        :return: The type of this SystemuserputpostAddresses.
        :rtype: str
        """
        return self._type
    ...
    def po_box(self):
        """
        Gets the po_box of this SystemuserputpostAddresses.

        :return: The po_box of this SystemuserputpostAddresses.
        :rtype: str
        """
        return self._po_box
    ...
    def extended_address(self):
        """
        Gets the extended_address of this SystemuserputpostAddresses.

        :return: The extended_address of this SystemuserputpostAddresses.
        :rtype: str
        """
    ...
    def street_address(self):
        """
        Gets the street_address of this SystemuserputpostAddresses.

        :return: The street_address of this SystemuserputpostAddresses.
        :rtype: str
        """
    ...
    def locality(self):
        """
        Gets the locality of this SystemuserputpostAddresses.

        :return: The locality of this SystemuserputpostAddresses.
        :rtype: str
        """
    ...
    def region(self):
        """
        Gets the region of this SystemuserputpostAddresses.

        :return: The region of this SystemuserputpostAddresses.
        :rtype: str
        """
        return self._region
    ...
    def postal_code(self):
        """
        Gets the postal_code of this SystemuserputpostAddresses.

        :return: The postal_code of this SystemuserputpostAddresses.
        :rtype: str
        """
    ...
    def country(self):
        """
        Gets the country of this SystemuserputpostAddresses.

        :return: The country of this SystemuserputpostAddresses.
        :rtype: str
        """
