...
import six
from jcapiv1.models.error import Error  # noqa: F401,E501
...
class ErrorDetails(Error):
    ...
    def details(self):
        ...
        Describes a list of objects with more detailed information of the given error. Each detail schema is according to one of the messages defined in Google's API: https://github.com/googleapis/googleapis/blob/master/google/rpc/error_details.proto\"   # noqa: E501
