...
class StateActivateBody(object):
    ...
    def __init__(self, email=None):  # noqa: E501
        """StateActivateBody - a model defined in Swagger"""  # noqa: E501
        self._email = None
    ...
    @property
    def email(self):
        """Gets the email of this StateActivateBody.  # noqa: E501


        :return: The email of this StateActivateBody.  # noqa: E501
        :rtype: object
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this StateActivateBody.


        :param email: The email of this StateActivateBody.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StateActivateBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StateActivateBody):
            return False
