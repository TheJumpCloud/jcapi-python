...
class OrganizationsIdBody(object):
    ...
    def __init__(self, settings=None):  # noqa: E501
        """OrganizationsIdBody - a model defined in Swagger"""  # noqa: E501
        self._settings = None
    ...
    @property
    def settings(self):
        """Gets the settings of this OrganizationsIdBody.  # noqa: E501


        :return: The settings of this OrganizationsIdBody.  # noqa: E501
        :rtype: Organizationsettingsput
        """
        return self._settings

    @settings.setter
    def settings(self, settings):
        """Sets the settings of this OrganizationsIdBody.


        :param settings: The settings of this OrganizationsIdBody.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrganizationsIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrganizationsIdBody):
            return False
