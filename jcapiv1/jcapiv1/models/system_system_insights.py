...
class SystemSystemInsights(object):
    ...
    def __init__(self, state=None):  # noqa: E501
        """SystemSystemInsights - a model defined in Swagger"""  # noqa: E501
        self._state = None
    ...
    @property
    def state(self):
        """Gets the state of this SystemSystemInsights.  # noqa: E501


        :return: The state of this SystemSystemInsights.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this SystemSystemInsights.


        :param state: The state of this SystemSystemInsights.  # noqa: E501
        :type: str
        """
        allowed_values = ["enabled", "disabled", "deferred"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SystemSystemInsights, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SystemSystemInsights):
            return False
