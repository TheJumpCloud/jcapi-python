...
class Tag(object):
    ...
    def __init__(self, id=None, expired=None, external_dn=None, external_source_type=None, externally_managed=None, group_gid=None, group_name=None, name=None, regular_expressions=None, send_to_ldap=None, systems=None, systemusers=None):  # noqa: E501
