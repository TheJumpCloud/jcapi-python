...
class Tagpost(object):
    ...
    def __init__(self, name=None, systems=None, systemusers=None, regular_expressions=None, externally_managed=None, external_dn=None, external_source_type=None, send_to_ldap=None, group_gid=None, group_name=None):
        """
        Tagpost - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this Tagpost.
        A unique name for the Tag.

        :return: The name of this Tagpost.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this Tagpost.
        :type: str
        """
        if name is None:
    ...
    def systems(self):
        """
        Gets the systems of this Tagpost.
        An array of system ids that are associated to the Tag.

        :return: The systems of this Tagpost.
        :rtype: list[str]
        """
    ...
    def systems(self, systems):
        ...
        :param systems: The systems of this Tagpost.
        :type: list[str]
        """
    ...
    def systemusers(self):
        """
        Gets the systemusers of this Tagpost.
        An array of system user ids that are associated to the Tag.

        :return: The systemusers of this Tagpost.
        :rtype: list[str]
        """
    ...
    def systemusers(self, systemusers):
        ...
        :param systemusers: The systemusers of this Tagpost.
        :type: list[str]
        """
    ...
    def regular_expressions(self):
        """
        Gets the regular_expressions of this Tagpost.

        :return: The regular_expressions of this Tagpost.
        :rtype: list[str]
        """
    ...
    def regular_expressions(self, regular_expressions):
        ...
        :param regular_expressions: The regular_expressions of this Tagpost.
        :type: list[str]
        """
    ...
    def externally_managed(self):
        """
        Gets the externally_managed of this Tagpost.

        :return: The externally_managed of this Tagpost.
        :rtype: bool
        """
    ...
    def externally_managed(self, externally_managed):
        ...
        :param externally_managed: The externally_managed of this Tagpost.
        :type: bool
        """
    ...
    def external_dn(self):
        """
        Gets the external_dn of this Tagpost.

        :return: The external_dn of this Tagpost.
        :rtype: str
        """
    ...
    def external_dn(self, external_dn):
        ...
        :param external_dn: The external_dn of this Tagpost.
        :type: str
        """
    ...
    def external_source_type(self):
        """
        Gets the external_source_type of this Tagpost.

        :return: The external_source_type of this Tagpost.
        :rtype: str
        """
    ...
    def external_source_type(self, external_source_type):
        ...
        :param external_source_type: The external_source_type of this Tagpost.
        :type: str
        """
    ...
    def send_to_ldap(self):
        """
        Gets the send_to_ldap of this Tagpost.

        :return: The send_to_ldap of this Tagpost.
        :rtype: bool
        """
    ...
    def send_to_ldap(self, send_to_ldap):
        ...
        :param send_to_ldap: The send_to_ldap of this Tagpost.
        :type: bool
        """
    ...
    def group_gid(self):
        """
        Gets the group_gid of this Tagpost.

        :return: The group_gid of this Tagpost.
        :rtype: str
        """
    ...
    def group_gid(self, group_gid):
        ...
        :param group_gid: The group_gid of this Tagpost.
        :type: str
        """
    ...
    def group_name(self):
        """
        Gets the group_name of this Tagpost.

        :return: The group_name of this Tagpost.
        :rtype: str
        """
    ...
    def group_name(self, group_name):
        ...
        :param group_name: The group_name of this Tagpost.
        :type: str
        """
