...
class SystemsApi(object):
    ...
    def systems_list_with_http_info(self, content_type, accept, **kwargs):  # noqa: E501
        ...
        if 'skip' in params and params['skip'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `skip` when calling `systems_list`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def systems_systemusers_binding_list_with_http_info(self, id, content_type, accept, **kwargs):  # noqa: E501
        ...
        if 'skip' in params and params['skip'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `skip` when calling `systems_systemusers_binding_list`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
