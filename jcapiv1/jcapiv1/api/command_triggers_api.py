...
class CommandTriggersApi(object):
    ...
    def command_trigger_webhook_post(self, triggername, **kwargs):  # noqa: E501
        ...
        >>> thread = api.command_trigger_webhook_post(triggername, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.command_trigger_webhook_post_with_http_info(triggername, **kwargs)  # noqa: E501
        else:
            (data) = self.command_trigger_webhook_post_with_http_info(triggername, **kwargs)  # noqa: E501
            return data

    def command_trigger_webhook_post_with_http_info(self, triggername, **kwargs):  # noqa: E501
        """Launch a command via a Trigger  # noqa: E501

        This endpoint allows you to launch a command based on a defined trigger.  #### Sample Requests  **Launch a Command via a Trigger**  ``` curl --silent \\      -X 'POST' \\      -H \"x-api-key: {API_KEY}\" \\      \"https://console.jumpcloud.com/api/command/trigger/{TriggerName}\" ``` **Launch a Command via a Trigger passing a JSON object to the command** ``` curl --silent \\      -X 'POST' \\      -H \"x-api-key: {API_KEY}\" \\      -H 'Accept: application/json' \\      -H 'Content-Type: application/json' \\      -d '{ \"srcip\":\"192.168.2.32\", \"attack\":\"Cross Site Scripting Attempt\" }' \\      \"https://console.jumpcloud.com/api/command/trigger/{TriggerName}\" ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.command_trigger_webhook_post_with_http_info(triggername, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['triggername', 'body', 'x_org_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='Triggerreturn',  # noqa: E501
