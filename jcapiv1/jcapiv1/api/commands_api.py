...
class CommandsApi(object):
    ...
    def command_file_get(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.command_file_get(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.command_file_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.command_file_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def command_file_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a Command File  # noqa: E501

        This endpoint returns the uploaded file(s) associated with a specific command.  #### Sample Request  ``` curl -X GET https://console.jumpcloud.com/api/files/command/{commandID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}'   ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.command_file_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'fields', 'limit', 'x_org_id', 'skip']  # noqa: E501
    ...
    def commands_delete(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.commands_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.commands_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def commands_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete a Command  # noqa: E501

        This endpoint deletes a specific command based on the Command ID.  #### Sample Request ``` curl -X DELETE https://console.jumpcloud.com/api/commands/{CommandID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}'  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def commands_get(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.commands_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.commands_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def commands_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """List an individual Command  # noqa: E501

        This endpoint returns a specific command based on the command ID.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/commands/{CommandID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'fields', 'x_org_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def commands_get_results(self, id, **kwargs):  # noqa: E501
        """Get results for a specific command  # noqa: E501

        This endpoint returns results for a specific command.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/commands/{id}/results \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}'   ````  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_get_results(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.commands_get_results_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.commands_get_results_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def commands_get_results_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get results for a specific command  # noqa: E501

        This endpoint returns results for a specific command.  #### Sample Request ``` curl -X GET https://console.jumpcloud.com/api/commands/{id}/results \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}'   ````  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_get_results_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method commands_get_results" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `commands_get_results`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Commandresult]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def commands_list(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.commands_list_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def commands_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.commands_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.commands_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def commands_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create A Command  # noqa: E501

        This endpoint allows you to create a new command.  #### Sample Request  ``` curl -X POST https://console.jumpcloud.com/api/commands/ \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{  \"name\":\"Test API Command\",  \"command\":\"String\",  \"user\":\"{UserID}\",  \"schedule\":\"\",  \"timeout\":\"100\" }'  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def commands_put(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_put(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.commands_put_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.commands_put_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def commands_put_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update a Command  # noqa: E501

        This endpoint Updates a command based on the command ID and returns the modified command record.  #### Sample Request ``` curl -X PUT https://console.jumpcloud.com/api/commands/{CommandID} \\   -H 'Accept: application/json' \\   -H 'Content-Type: application/json' \\   -H 'x-api-key: {API_KEY}' \\   -d '{  \"name\":\"Test API Command\",  \"command\":\"String\",  \"user\":\"{UserID}\",  \"schedule\":\"\",  \"timeout\":\"100\" }'  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commands_put_with_http_info(id, async_req=True)
        >>> result = thread.get()
