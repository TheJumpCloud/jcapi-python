...
class SearchApi(object):
    ...
    def search_organizations_post_with_http_info(self, content_type, accept, **kwargs):  # noqa: E501
        ...
        if 'skip' in params and params['skip'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `skip` when calling `search_organizations_post`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def search_systems_post_with_http_info(self, content_type, accept, **kwargs):  # noqa: E501
        ...
        if 'skip' in params and params['skip'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `skip` when calling `search_systems_post`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def search_systemusers_post_with_http_info(self, content_type, accept, **kwargs):  # noqa: E501
        ...
        if 'skip' in params and params['skip'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `skip` when calling `search_systemusers_post`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
