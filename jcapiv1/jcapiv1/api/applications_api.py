...
class ApplicationsApi(object):
    ...
    def applications_delete(self, id, **kwargs):  # noqa: E501
        ...
        The endpoint deletes an SSO / SAML Application.  # noqa: E501
    ...
    def applications_get(self, id, **kwargs):  # noqa: E501
        """Get an Application  # noqa: E501

        The endpoint retrieves an SSO / SAML Application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.applications_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.applications_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def applications_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get an Application  # noqa: E501

        The endpoint retrieves an SSO / SAML Application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `applications_get`")  # noqa: E501
    ...
    def applications_post(self, **kwargs):  # noqa: E501
        ...
        The endpoint adds a new SSO / SAML Applications.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def applications_put(self, id, **kwargs):  # noqa: E501
        """Update an Application  # noqa: E501

        The endpoint updates a SSO / SAML Application. Any fields not provided will be reset or created with default values.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_put(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.applications_put_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.applications_put_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def applications_put_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update an Application  # noqa: E501

        The endpoint updates a SSO / SAML Application. Any fields not provided will be reset or created with default values.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_put_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method applications_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `applications_put`")  # noqa: E501
